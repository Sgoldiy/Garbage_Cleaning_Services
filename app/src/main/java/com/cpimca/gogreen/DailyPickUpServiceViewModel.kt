...
class DailyPickUpServiceViewModel : ViewModel() {
    ...
    fun storeRequest(
        ...
        firestore.collection("users").document(userId!!).get()
            .addOnSuccessListener { documentSnapshot ->
                ...
                firestore.collection("requestForDailyPickUpService").add(request)
    ...
    fun removeFromCurrentCollection(request: PickupServiceRequest) {
        ...
        val currentRequestsRef = db.collection("requestForDailyPickUpService")
...
class PickupServiceRepository {
    ...
    suspend fun getPickupServiceRequests(): List<PickupServiceRequest> {
        ...
        val snapshot = firestore.collection("requestForDailyPickUpService").get().await()
