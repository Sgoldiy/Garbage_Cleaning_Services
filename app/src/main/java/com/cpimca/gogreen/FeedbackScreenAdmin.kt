...
@Composable
fun FeedbackScreenAdmin(navController: NavController) {
    val viewModel: FeedbackClassViewModel = viewModel()
        ...
        Row(
            ...
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 8.dp)
                    .clickable {
                        navController.popBackStack(Route.FeedbackScreenAdmin, inclusive = true)
                    }
            )
            Text(
                text = "All feedbacks Regarding improvement",
                style = TextStyle(
                    color = Color.White,
                    fontSize = 16.sp
                ),
