...
@Composable
fun DustbinService(navController: NavController) {
    Box(
        ...
        Column(
            ...
            Card(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .clickable { navController.navigate(Route.DustbinServiceUser) },
                    ...
                    Row(
                        ...
                        Text(
                            text = "Request For Dustbin", style = TextStyle(
                                color = Color.White,
            ...
            Card(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .clickable { navController.navigate(Route.DustbinServiceConfirmUser) },
                    contentAlignment = Alignment.Center
                ) {
                    Row(
                        modifier = Modifier
