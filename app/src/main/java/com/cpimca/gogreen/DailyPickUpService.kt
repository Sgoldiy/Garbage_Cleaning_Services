...
@Composable
fun DailyPickUpService(navController: NavController) {
    Box(
        ...
        Column(
            ...
            Text(
                text = "Make a request for Pick-up Service",
                style = TextStyle(
            ...
            Card(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .clickable { navController.navigate(Route.DailyPickUpServiceUser) },
                    ...
                    Row(
                        ...
                        Text(
                            text = "Request For Pick-up", style = TextStyle(
                                color = Color.White,
            ...
            Card(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .clickable { navController.navigate(Route.DailyPickUpServiceConfirmUser) },
                    contentAlignment = Alignment.Center
                ) {
                    Row(
                        modifier = Modifier
                        ...
                        Spacer(modifier = Modifier.width(16.dp)) // Space between image and text
                        Text(
                            text = "Confirm Pick-up", style = TextStyle(
                                color = Color.White,
                                fontSize = 18.sp // Adjust font size as needed
                            )
                        )
