...
@Composable
fun ComplainScreen2Admin(navController: NavController) {
    val viewModel: Complaint2ViewModel = viewModel()
        ...
        Row(
            ...
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 8.dp)
                    .clickable {
                        navController.popBackStack(Route.ComplainScreen2Admin, inclusive = true)
                    }
            )
            Text(
                text = "All Complaints Regarding the Dustbin Service",
                style = TextStyle(
                    color = Color.White,
                    fontSize = 16.sp
                ),
    ...
    LazyColumn(modifier = Modifier
        ...
        items(complaints) { complaint ->
            ComplaintCard2(complaint)
        }
    }
}

@Composable
fun ComplaintCard2(complaint: Complaint2) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
