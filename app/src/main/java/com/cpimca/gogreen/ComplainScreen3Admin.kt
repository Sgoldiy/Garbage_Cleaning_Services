...
@Composable
fun ComplainScreen3Admin(navController: NavController) {
    val viewModel: Complaint3ViewModel = viewModel()
        ...
        Row(
            ...
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 8.dp)
                    .clickable {
                        navController.popBackStack(Route.ComplainScreen3Admin, inclusive = true)
                    }
            )
            Text(
                text = "All Complaints Regarding the Pick-up Service",
                style = TextStyle(
                    color = Color.White,
                    fontSize = 16.sp
                ),
    ...
    LazyColumn(modifier = Modifier
        ...
        items(complaints) { complaint ->
            ComplaintCard3(complaint)
        }
    }
}

@Composable
fun ComplaintCard3(complaint: Complaint3) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
