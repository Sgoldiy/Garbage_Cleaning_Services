                ...
                modifier = Modifier
                    ...
                    .clickable {
                        navController.navigate(Route.DashBoard) {
                            popUpTo(Route.DailyPickUpServiceAdmin) {
                                inclusive = true
                            }
                        }
                    }
        ...
        Column(
            ...
            Button(
                onClick = {
                    onConfirm(request)
                    navController.navigate(Route.DashBoard) {
                        popUpTo(Route.DailyPickUpService) {
                            inclusive = true
                        }
                    }
                },
...
fun UserRequestPickUp(
    viewModel: DailyPickUpServiceViewModel = androidx.lifecycle.viewmodel.compose.viewModel(),
    navController: NavController,
) {
