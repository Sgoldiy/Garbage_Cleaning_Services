...
@Composable
fun ComplainScreen2(navController: NavController) {
    var selectedOptionIndex by remember { mutableStateOf(0) }
    val options = listOf("Quantity issue", "Late Service", "Worker Behavior Issue" , "Wrong Dustbin receive")
        ...
        Row(
            ...
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 8.dp)
                    .clickable {
                        navController.popBackStack(Route.ComplainScreen2, inclusive = true)
                    }
            )
            Text(
        ...
        Column(
            ...
            Button(
                ...
                onClick = {
                    ...
                    storeComplaintData2(selectedOption)
                    navController.popBackStack(Route.ComplainScreen2, inclusive = true)
                },
            ) {
                Text(
...
fun storeComplaintData2(complaint: String) {
    ...
    db.collection("complaintsOfDustbinService")
        .add(complaintData)
