...
@Composable
fun ComplainScreen3(navController: NavController) {
    var selectedOptionIndex by remember { mutableStateOf(0) }
    val options = listOf("Pickup is not arrive", "Late Service", "Worker Behavior Issue")
        ...
        Row(
            ...
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 8.dp)
                    .clickable {
                        navController.popBackStack(Route.ComplainScreen3, inclusive = true)
                    }
            )
            Text(
        ...
        Column(
            ...
            Button(
                ...
                onClick = {
                    ...
                    storeComplaintData3(selectedOption)
                    navController.popBackStack(Route.ComplainScreen3, inclusive = true)
                },
            ) {
                Text(
...
fun storeComplaintData3(complaint: String) {
    ...
    db.collection("complaintsOfPickupService")
        .add(complaintData)
